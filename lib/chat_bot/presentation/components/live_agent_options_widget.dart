...
class LiveAgentOptionsWidget extends StatelessWidget {
  final Function(int) selectedType;
  LiveAgentOptionsWidget({Key? key, required this.selectedType})
      : super(key: key);

  final List<Tuple2<int, String>> products = [
    const Tuple2(0, 'Text Chat'),
    const Tuple2(1, 'Voice Call'),
  ];
